...
import com.ego.im4bmob.adapter.ContactAdapter;
...
//        iv_recent_avatar.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                Toast.makeText(getActivity(),"你点击了用户头像",Toast.LENGTH_SHORT).show();
//            }
//        });
        adapter.setOnRecyclerViewListener(new OnRecyclerViewListener() {
            @Override
            public void onItemClick(int position) {
                if (position == 0) {//跳转到新朋友页面an
