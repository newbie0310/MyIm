...
public class SetUserInfoActivity extends ParentWithNaviActivity {
                            ...
                            installation.updateObservable()
                                    .subscribe(new Action1<Void>() {
                                        ...
                                        public void call(Void aVoid) {
                                            BmobUtils.toast(SetUserInfoActivity.this,"退出成功！");
                                            /**
                                             * TODO 更新成功之后再退出
                                             */
                                            ...
                                            BmobUser.logOut();
                                            startActivity(new Intent(SetUserInfoActivity.this, LogActivity.class));
    ...
    public void select() {
        ...
        if (ContextCompat.checkSelfPermission(SetUserInfoActivity.this,
            ...
            Toast.makeText(SetUserInfoActivity.this,"你需要申请权限",Toast.LENGTH_SHORT).show();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_SELECT_IMAGE) {
            if (resultCode == RESULT_OK) {
                ...
                final ProgressDialog progressDialog = new ProgressDialog(SetUserInfoActivity.this);
                progressDialog.setTitle("正在上传头像……");
                progressDialog.show();
                Glide.with(SetUserInfoActivity.this).load(paths.get(0)).into(mCivAvatar);
                    ...
                    public void done(BmobException e) {
                        if (e == null) {
                            ...
                            user.updateObservable().subscribe(new Action1<Void>() {
                                @Override
                                public void call(Void aVoid) {
                                    Toast.makeText(SetUserInfoActivity.this, "更新头像成功", Toast.LENGTH_SHORT).show();
                                    Logger.d("更新头像成功");
                                    progressDialog.dismiss();
                                ...
                                @Override
                                public void call(Throwable throwable) {
                                    Toast.makeText(SetUserInfoActivity.this, "更新头像失败：" + throwable.getMessage(), Toast.LENGTH_SHORT).show();
                                    progressDialog.dismiss();
                            ...
                            progressDialog.dismiss();
                            Toast.makeText(SetUserInfoActivity.this, "上传头像失败：" + e.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        switch (requestCode) {
            case REQUEST_READ_EXTERNAL_STORAGE: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(SetUserInfoActivity.this, "您已经同意了读取外置存储器权限", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(SetUserInfoActivity.this, "您已经拒绝了读取外置存储器权限", Toast.LENGTH_SHORT).show();
            ...
            case REQUEST_WRITE_EXTERNAL_STORAGE: {
                ...
                if (grantResults.length > 0
                        && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(SetUserInfoActivity.this, "您已经同意了写入外置存储器权限", Toast.LENGTH_SHORT).show();
                    // permission was granted, yay! Do the
                    // contacts-related task you need to do.

                } else {
                    Toast.makeText(SetUserInfoActivity.this, "您已经拒绝了写入外置存储器权限", Toast.LENGTH_SHORT).show();
                    // permission denied, boo! Disable the
                    // functionality that depends on this permission.
                }
                return;
            ...
            case REQUEST_CAMERA: {
                ...
                if (grantResults.length > 0
                        && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(SetUserInfoActivity.this, "您已经同意了照相机权限", Toast.LENGTH_SHORT).show();
                    // permission was granted, yay! Do the
                    // contacts-related task you need to do.

                } else {
                    Toast.makeText(SetUserInfoActivity.this, "您已经拒绝了照相机权限", Toast.LENGTH_SHORT).show();
                    // permission denied, boo! Disable the
                    // functionality that depends on this permission.
                }
                return;
